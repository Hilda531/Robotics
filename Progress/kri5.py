...
def ambil():
    ...
    print("HAHA")
    # ser.write(str.encode(str(int(cx31))))  # str encode itu karna biasa dipake,
    # cx31 itu float karna hasil dari filternya, makannya diubah jadi int. trus diubah lagi jadi str karna str.encode perlu value str.
    ...
    while (True):
        ...
        # Crop the image
        crop_img = frame[80:320, 0:640] #vertikal:horizontal
        cv2.rectangle(crop_img, (210, 0), (430, 240), (0, 0, 255), 1)
